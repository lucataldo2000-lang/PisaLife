...
public class EventChecker {
    ...
    public void checkEvent(){
        ...
        if(waitTime >= 30){
            ...
            if(checkTeleport(1,8,0,13)){gp.currentRoom = 0; waitTime = 0;setPlayerValues(480,250, "left");}
            if(checkTeleport(1,9,0,14)){gp.currentRoom = 0; waitTime = 0;setPlayerValues(480,250, "left");}
