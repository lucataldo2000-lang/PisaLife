...
public class TileManager extends Tile{
    ...
    public void getTileImages() {
        try {
            ...
            tiles[12] = new Tile();
            tiles[12].image = ImageIO.read(getClass().getResourceAsStream("/TilesTextures/Cobble.png"));

            tiles[15] = new Tile();
            tiles[15].image = ImageIO.read(getClass().getResourceAsStream("/TilesTextures/Cobble.png"));
            tiles[15].collision = true;

            tiles[17] = new Tile();
            tiles[17].image = ImageIO.read(getClass().getResourceAsStream("/TilesTextures/Cobble.png"));
